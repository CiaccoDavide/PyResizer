...
def resize(max_size,inputImage):
    ...
    outputImageName=os.path.splitext(inputImage)[0]+"_"+str(max_size)+"."+outputFormat 	#nome del file in output (si potrebbe aggiungere una stringa all'inizio o alla fine a piacere)
